    ...
    del_vlan: [
      {
        ...
        description:
          "del_vlan Deletes a VLAN from a device.\n\nArgs:\n    device_ip (str): The IP address of the device.\n    vlan_name (str): The name of the VLAN to be deleted.\n\nReturns:\n    None",
        missing_args_desc:
          "Operation 2: - Deleting a VLAN cannot proceed as it needs the 'device IP' along with the VLAN name vlan1.",
      },
    ],
    ...
    add_port_chnl: [
      {
        ...
        confirmation_desc:
          "Operation 1: - A port channel with channel name portchannel101 will be added on device with IP 10.10.229.111, and its administrative status will be set to down.",
      },
    ],
    config_interface: [
      {
        ...
        confirmation_desc:
          "Operation 2: - An interface named ethernet 56 on device with IP 10.10.229.111 will be configured, with its enable status set to False.",
      },
    ],
    request_for_confirmation:
      "I need your confirmation for the above operations.",
